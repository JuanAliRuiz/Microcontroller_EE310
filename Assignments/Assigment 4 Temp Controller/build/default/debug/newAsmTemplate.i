...
Hexconversion:
    MOVLW 15 ; this is the input value
    MOVWF calc ;place 15 ; this is the input value into placeholder register "calc"
    MOVLW 100
CASE1:
...
CASE2:
    ...
    CLRF counter
    MOVLW -5 ; this is the input value ;repeat process above for measured temp value conversion
    MOVWF calc
    BTFSC calc,7
    NEGF calc
    MOVLW 100
