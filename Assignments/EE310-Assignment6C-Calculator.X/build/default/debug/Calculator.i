...
char scan_keypad() {
    ...
    LATBbits.LATB0 = LATBbits.LATB1 = LATBbits.LATB2 = LATBbits.LATB3 = 0;
        ...
        if (PORTBbits.RB4 == 1) { while (PORTBbits.RB4 == 1); return keypad[row][0]; }
        if (PORTBbits.RB5 == 1) { while (PORTBbits.RB5 == 1); return keypad[row][1]; }
        if (PORTBbits.RB6 == 1) { while (PORTBbits.RB6 == 1); return keypad[row][2]; }
        if (PORTBbits.RB7 == 1) { while (PORTBbits.RB7 == 1); return keypad[row][3]; }
    }
