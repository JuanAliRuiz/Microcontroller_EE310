...
FINAL_IMAGE=${DISTDIR}/SigGenLab6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=SigGen.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/SigGen.o
POSSIBLE_DEPFILES=${OBJECTDIR}/SigGen.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/SigGen.o

# Source Files
SOURCEFILES=SigGen.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/SigGenLab6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F46K42
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/SigGenLab6.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/SigGen.o: SigGen.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/SigGen.o 
	${MP_AS} -mcpu=PIC18F46K42 -c \
	-o ${OBJECTDIR}/SigGen.o \
	SigGen.asm \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/SigGenLab6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F46K42 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/SigGenLab6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
